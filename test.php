...
<head>
    ...
    <title>SportsCenter Management System</title>
</head>

<body>
    <div class="container">
        <div class="toppane">
            <h1 style="color: white; font-size: 40px;">SportsCenter Management System</h1>
        ...
        <div class="d-flex">
            <div class="leftpane">
                ...
                <form method="POST" action="test.php">
                    <li>
                        <input type="submit" name="SportsCenterTag" value="SportsCenter" , style="font-size: 25px;" />
                    </li>
    ...
    function displayFromDB($table, $value)
    {
        global $db_conn;
        if (connectToDB()) {
            ...
            switch ($table) {
                case "SportsCenter":
                    ...
                    color:black; 
                    font-size: 20px;
                    text-align:center;"> SportsCenter </p>
                    <tr>
                    <th>SportsCenterLocation</th>
                    <th>ContactNumber</th>
                    <th>Hours</th>
                    <th>PRICE</th>
                    <th>Address</th>
            ...
            switch ($table) {
                case "SportsCenter":
                    while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                        echo '<tr>
                        <td> ' . $row["SportsCenterLocation"] . '</td>
